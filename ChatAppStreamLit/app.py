...
model_id: str ="jedlee2004/physics-chat"

def get_llm_hf_inference(model_id=model_id, max_new_tokens=1024, temperature=0.1):
    """
    Returns a language model for HuggingFace inference.
    """
    llm = HuggingFaceEndpoint(
        repo_id=model_id,
        task="text-generation",  # Replace with the correct task
...
st.set_page_config(page_title="Physics ChatBot", page_icon="🤗")
